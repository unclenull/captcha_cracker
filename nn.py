...
X = np.array([[2,1],  [2,-111],  [-1,1],  [-1,-1],  [1,-1]])      # 用于训练的坐标，对应的是I、II、III、IV象限
t = np.array([0,3,1,2,3])   # 标签，对应的是I、II、III、IV象限
...
num_classes = 4   # 输出参数的维度，此处为4，即最终分为四个象限
...
for j in range(1000):   #这里设置了训练的循环次数为10000
 # ①前向传播
